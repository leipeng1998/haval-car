...
export function createDisplaySelectionScreen() {
    ...
    const render = () => {
        ...
        const menuItemsData = [
            { id: 'title_mask', label: '主题模式', type: 'title' },
            { id: 'mode_normal', label: '标准', type: 'mode', value: 'Normal', iconSrc: getIconNormal(themeBlue) },
            { id: 'mode_reduzido', label: '精简', type: 'mode', value: 'Reduzido', iconSrc: getIconReduced(themeBlue) },
            { id: 'mode_clean', label: '简洁', type: 'mode', value: 'Clean', iconSrc: getIconClean(themeBlue) },
            { id: 'mode_esportivoclean', label: '运动简洁', type: 'mode', value: 'EsportivoClean', iconSrc: getIconSport(themeBlue) }
        ];
