...
export const menuItems = [
    ...
    { id: 'option_3', label: '模式', stateKey: 'drivingMode', iconSrc: iconMode },
    { id: 'option_7', label: '图表', iconSrc: iconProfiles },
    { id: 'option_5', label: '模式', stateKey: 'steerMode', iconSrc: iconSteer },
    { id: 'option_6', label: '能量回收', iconSrc: iconRegen },
    { id: 'option_4', label: '显示模式', iconSrc: iconDisplay },
];
